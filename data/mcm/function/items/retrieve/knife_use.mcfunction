...
execute if data entity @s SelectedItem run data merge storage mcm:args {slot:-2}
# Otherwise put in mainhand
execute unless data entity @s SelectedItem run data merge storage mcm:args {slot:-1}
