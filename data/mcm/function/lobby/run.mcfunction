...
tag @a[predicate=mcm:map_bounds/lobby/theater_grate] add came_from_grate
tp @a[predicate=mcm:map_bounds/lobby/theater_grate] 36 1 -11 180 0
execute as @a[predicate=mcm:map_bounds/lobby/test_range] run function mcm:lobby/test_range/control
execute as @a[tag=test_range,predicate=!mcm:map_bounds/lobby/test_range] run function mcm:lobby/test_range/leave
tag @a[predicate=!mcm:map_bounds/lobby/test_range,tag=came_from_grate] remove came_from_grate
execute if score $test_range_active vars matches 1 unless entity @a[predicate=mcm:map_bounds/lobby/test_range] run function mcm:lobby/test_range/reset
...
#> Manage AFK players
#> TODO: Make sure these scoreboards get initialized
...
function mcm:lobby/displays/animate
