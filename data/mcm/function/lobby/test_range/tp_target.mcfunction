...
execute as @e[type=husk,tag=test_range_target] at @s run playsound entity.enderman.teleport ambient @a ~ ~ ~ 1 1 1
execute as @e[type=husk,tag=test_range_target] at @s run playsound block.beacon.deactivate ambient @a ~ ~ ~ 1 2 1 
