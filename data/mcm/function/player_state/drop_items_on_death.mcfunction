...
scoreboard players add $player_drop_inv_idx vars 1
execute store result storage mcm:player_inv_drop idx int 1 run scoreboard players get $player_drop_inv_idx vars
