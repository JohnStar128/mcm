...
execute if score $launchTime CmdData matches 340..359 run particle lava -1016 76 -922 1 2 1 1 200 force
...
execute if score $launchTime CmdData matches 360..379 run particle lava -1016 66 -922 1 2 1 1 200 force
...
execute if score $launchTime CmdData matches 380..399 run particle lava -1016 61 -922 1 2 1 1 200 force
...
execute if score $launchTime CmdData matches 400..419 run particle lava -1016 56 -922 1 2 1 1 200 force
...
execute if score $launchTime CmdData matches 420..439 run particle lava -1016 51 -922 1 2 1 1 200 force
...
execute if score $launchTime CmdData matches 420..460 run particle campfire_signal_smoke -1016 49 -922 2 2 2 .1 5 force
