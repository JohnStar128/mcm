...
execute as @e[type=armor_stand,tag=riverboat_secret,tag=take,limit=3,sort=random] run data merge entity @s {HandItems:[{id:"minecraft:stick",count:1b,components:{max_stack_size:1,custom_model_data:1116,custom_name:"{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":\"false\"}"}},{}],DisabledSlots:16383}
execute as @e[type=armor_stand,tag=riverboat_secret,tag=take,limit=2,sort=random,nbt=!{HandItems:[{id:"minecraft:stick",count:1b,components:{custom_model_data:1116}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:stick",count:1b,components:{max_stack_size:1,custom_model_data:1117,display:{Name:"{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":\"false\"}"}}},{}],DisabledSlots:16383}
