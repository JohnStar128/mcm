...
execute as @e[type=armor_stand,tag=riverboat_secret,tag=take,limit=3,sort=random] run data merge entity @s {HandItems:[{id:"minecraft:stick",count:1b,components:{max_stack_size:1,item_model:"minecraft:misc/playingcard",custom_name:"{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":\"false\"}"}},{}],DisabledSlots:16383}
execute as @e[type=armor_stand,tag=riverboat_secret,tag=take,limit=2,sort=random,nbt=!{HandItems:[{id:"minecraft:stick",count:1b,components:{item_model:"minecraft:misc/playingcard8"}},{}]}] run data merge entity @s {HandItems:[{id:"minecraft:stick",count:1b,components:{max_stack_size:1,item_model:"minecraft:misc/playingcard8",display:{Name:"{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":\"false\"}"}}},{}],DisabledSlots:16383}
