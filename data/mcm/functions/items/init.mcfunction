...
data modify storage mcm:items knife set value {slot:1,id:"snowball", nbt:{custom_data:{murderer:1b,item:"knife",knife:1b,NoDrop:0b,no_drop_on_death:1b},custom_model_data:1111,custom_name:'[{"translate":"mcm.item.knife","italic":false}]',lore:['[{"translate":"mcm.item.knife.lore","italic":false}]']}}
...
data modify storage mcm:items knife.components set value '[custom_data={murderer:1b,item:"knife",knife:1b,NoDrop:0b,no_drop_on_death:1b},unbreakable={show_in_tooltip:false},custom_model_data=1111,custom_name=\'{"translate":"mcm.item.knife","italic":false}\',lore=[\'[{"translate":"mcm.item.knife.lore","italic":false}]\']]'
...
data modify storage mcm:items teleporter_retrieve set value {slot:3,id:"carrot_on_a_stick", cost:10, nbt:{custom_data:{murderer:1b,retrieve:"teleporter",cost:10,NoDrop:1b,no_drop_on_death:1b},custom_model_data:1115,custom_name:'[{"translate":"mcm.item.randomtp_retrieve","italic":false}]',lore:['[{"translate":"mcm.item.randomtp_retrieve.lore","italic":false}]']}}
...
data modify storage mcm:items knife_retrieve.components set value '[custom_data={murderer:1b,retrieve:"knife",knife_retrieve:1,cost:10,NoDrop:1b,no_drop_on_death:1b},custom_model_data=1111,custom_name=\'[{"translate":"mcm.item.knife_retrieve","italic":false}]\',lore=[\'[{"translate":"mcm.item.knife_retrieve.lore","italic":false}]\']]'
data modify storage mcm:items teleporter_retrieve.components set value '[custom_data={murderer:1b,retrieve:"teleporter",cost:10,NoDrop:1b,no_drop_on_death:1b},custom_model_data=1115,custom_name=\'[{"translate":"mcm.item.randomtp_retrieve","italic":false}]\',lore=[\'[{"translate":"mcm.item.randomtp_retrieve.lore","italic":false}]\']]'
