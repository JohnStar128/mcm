...
#> For this to work the item must be in the mainhand of the player
...
execute if score scrap temp >= cost temp run function mcm:items/give_mainhand with storage mcm:args
