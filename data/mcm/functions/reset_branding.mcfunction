...
bossbar set mcm:branding name {"text":"Back","color":"#6dc6ff","extra":[{"text":"stabbed!","color":"#ff5f79"},{"text":" v1.3.2 ","color":"white"},{"text":"by ","color":"white"},{"text":"Bagel Buddies","color":"gold"}]}
