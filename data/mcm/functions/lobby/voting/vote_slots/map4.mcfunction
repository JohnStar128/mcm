...
scoreboard players set @s vote_position 4
execute as @e[type=interaction,scores={vote_position=4}] store result score $current_vote vote_map_id run scoreboard players add @s vote_map_id 0
