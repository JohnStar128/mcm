...
scoreboard players set @s vote_position 3
execute as @e[type=interaction,scores={vote_position=3}] store result score $current_vote vote_map_id run scoreboard players add @s vote_map_id 0
