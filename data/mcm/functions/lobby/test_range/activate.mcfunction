...
data modify entity @e[type=item_display,tag=test_range_gun_display,limit=1] item.tag merge from storage mcm:items gun.nbt
...
data modify entity @e[type=item_display,tag=test_range_knife_display,limit=1] item.tag merge from storage mcm:items knife.nbt
...
data modify entity @e[type=item_display,tag=test_range_tracker_display,limit=1] item.tag merge from storage mcm:items player_tracker.nbt
...
data modify entity @e[type=item_display,tag=test_range_teleporter_display,limit=1] item.tag merge from storage mcm:items teleporter.nbt
...
data modify entity @e[type=item_display,tag=test_range_adrenaline_display,limit=1] item.tag merge from storage mcm:items adrenaline.nbt
