...
execute as @a[tag=!PopcornDelay,tag=HoldPopcorn,scores={popcornClick=1..}] at @s anchored eyes run particle item warped_fungus_on_a_stick{CustomModelData:1114} ^ ^-0.1 ^0.3 0.1 0.1 0.1 0.1 2 force @s
