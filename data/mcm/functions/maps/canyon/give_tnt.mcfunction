...
execute as @a[predicate=mcm:matches_uuid] run give @s tnt{display: {Lore: ['[{"translate":"mcm.canyon.tnt.lore","italic":false}]'],Name:'[{"translate":"mcm.canyon.tnt","italic":false,"color":"red"}]'}}
