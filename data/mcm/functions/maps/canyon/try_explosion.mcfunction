...
execute if score $canyon_partition CmdData matches 1 positioned 2971 -28 3045 run particle minecraft:flame ~ ~ ~ 0.05 0.5 0.05 0.01 100 force
execute if score $canyon_partition CmdData matches 2 positioned 2957 -27 3044 run particle minecraft:flame ~ ~ ~ 0.05 0.5 0.05 0.01 100 force
