...
tellraw @a ["","\n",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"The game is ready to play!","underlined":true,"color":"green"},"\n",{"text":"| ","bold":true,"color":"dark_gray"},"\n",{"text":"| ","bold":true,"color":"dark_gray"},{"text":"Selected Map: ","color":"gray"},{"text":"Color Filth","color":"dark_green","hoverEvent":{"action":"show_text","value":{"text":"Lost in a city of stars...","color":"aqua"}}},"\n"]