...
execute as @a[predicate=mcm:matches_uuid] run give @s book[custom_model_data=1111,lore=['[{"translate":"mcm.library.book.lore","italic":false}]'],custom_name='[{"translate":"mcm.library.book","italic":false,"color":"red"}]']
