...
item replace entity @s weapon.mainhand with stick[max_stack_size=1,custom_data={ace:1b},custom_model_data=1116,custom_name="{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":false}"] 1
