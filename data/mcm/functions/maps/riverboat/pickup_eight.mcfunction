...
item replace entity @s weapon.mainhand with stick[custom_data={eight:1b},custom_model_data=1117,custom_name="{\"translate\":\"mcm.item.card\",\"color\":\"gray\",\"italic\":false}"] 1
