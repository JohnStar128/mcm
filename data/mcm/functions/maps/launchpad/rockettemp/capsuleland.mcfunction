...
execute if score $launchTime CmdData matches 681 as @a[tag=launch_player] at @s run tp @s ~ ~-4 ~
execute if score $launchTime CmdData matches 681 as @a[tag=launch_player] at @s run playsound minecraft:entity.player.splash.high_speed block @s ~ ~ ~ 5 0.5
