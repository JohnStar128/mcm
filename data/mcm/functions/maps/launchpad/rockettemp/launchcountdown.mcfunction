...
execute if score $launchCountdown CmdData matches 40..1260 run title @a actionbar ["", {"text":"=-> T-","color":"red"},{"score":{"objective":"CmdData","name":"$launchTitle"},"color":"gold"}, {"text":" <-=","color":"red"}]
execute if score $launchCountdown CmdData matches 900 run playsound minecraft:launchbuildup block @a -1015 56 -1096 10
