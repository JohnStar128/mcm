...
item replace entity @s weapon.mainhand with tripwire_hook{display:{Name:'{"translate":"mcm.vineyard.truck_key","color":"gray","italic":false}'},vineyard_truck_keys:1b} 1
