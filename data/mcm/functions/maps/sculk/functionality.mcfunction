...
execute positioned 2980 105 979 if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:globe_banner_pattern"}}] if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:glass_bottle"}}] unless entity @e[type=item,distance=..5,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] run playsound minecraft:item.bottle.fill_dragonbreath block @a[distance=..5]
execute positioned 2980 105 979 if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:globe_banner_pattern"}}] if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:glass_bottle"}}] unless entity @e[type=item,distance=..5,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] run playsound minecraft:item.book.page_turn block @a[distance=..5]

execute positioned 2980 105 979 if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:globe_banner_pattern"}}] if entity @e[type=item,distance=..1,nbt={Item:{count:1,id:"minecraft:glass_bottle"}}] unless entity @e[type=item,distance=..5,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] run summon item ~ ~ ~ {Item:{components:{"minecraft:custom_model_data":1118,"minecraft:custom_name":'{"italic":false,"color":"aqua","translate":"mcm.item.bottle"}'},count:1,id:"minecraft:stick"}}
execute positioned 2980 105 979 if entity @e[type=item,distance=..1,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] run kill @e[type=item,distance=..5,nbt={Item:{count:1,id:"minecraft:glass_bottle"}}]
execute positioned 2980 105 979 if entity @e[type=item,distance=..1,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] run kill @e[type=item,distance=..5,nbt={Item:{count:1,id:"minecraft:globe_banner_pattern"}}]

#> Grant the advancement to the thrower of the item & register game event
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] at @s if block ~ ~-1 ~ minecraft:sculk run execute on origin run advancement grant @s only mcm:secrets/sculk/message
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] unless entity @s[tag=Processed] at @s if block ~ ~-1 ~ minecraft:sculk run execute on origin run scoreboard players set $event_type temp 1
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] unless entity @s[tag=Processed] at @s if block ~ ~-1 ~ minecraft:sculk run execute on origin run function mcm:game/summary/add_event {translate:"mcm.game.events.sculk.message", color:"green"}
execute as @e[type=item,nbt={Item:{components:{"minecraft:custom_model_data":1118},count:1,id:"minecraft:stick"}}] unless entity @s[tag=Processed] at @s if block ~ ~-1 ~ minecraft:sculk run tag @s add Processed
