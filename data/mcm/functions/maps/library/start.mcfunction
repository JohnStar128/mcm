...
execute if score $roundtimer CmdData matches 1 run scoreboard players set $gametimer CmdData 6000
execute if score $roundtimer CmdData matches 2 run scoreboard players set $gametimer CmdData 10000
