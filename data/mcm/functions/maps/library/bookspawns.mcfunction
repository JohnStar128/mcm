...
execute as @e[type=minecraft:armor_stand,tag=bookspawn,tag=!hasbook,limit=5,sort=random] at @s run data merge entity @s {Tags: ["hasbook","bookspawn"],ArmorItems:[{},{},{},{id: "minecraft:book", Count: 1b, tag: {CustomModelData:1111, display: {Lore: ['[{"text":"You should probably return this","italic":false}]'],Name:'[{"text":"Overdue Book","italic":false,"color":"red"}]'}}}]}
