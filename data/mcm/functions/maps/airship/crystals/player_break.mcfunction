...
execute if score $temp math matches 1.. run tellraw @s ["", {"text":"| ","bold":true,"color":"dark_gray"},{"text":"The weight of the crystal is too heavy, you can't carry any more","underlined":false,"color":"red"}]
