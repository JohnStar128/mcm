...
scoreboard players operation $x_seventh math = $temp math
scoreboard players operation $x_seventh math *= $temp math
scoreboard players operation $x_seventh math /= $one_thousand math
scoreboard players operation $x_seventh math *= $temp math
scoreboard players operation $x_seventh math /= $one_thousand math
scoreboard players operation $x_seventh math *= $temp math
scoreboard players operation $x_seventh math /= $one_thousand math
...
scoreboard players operation $x_seventh math /= $seven_fact math
