...
scoreboard players set $2^2 math 4
scoreboard players set $2^3 math 8
scoreboard players set $2^4 math 16
scoreboard players set $2^6 math 64
scoreboard players set $2^7 math 128
scoreboard players set $2^8 math 256
scoreboard players set $2^9 math 512
scoreboard players set $2^10 math 1024
scoreboard players set $2^11 math 2048
scoreboard players set $2^12 math 4096
scoreboard players set $2^13 math 8192
scoreboard players set $2^14 math 16384
scoreboard players set $2^15 math 32768
...
scoreboard players set $B1 math 1373181078
scoreboard players set $C1 math 146210

# 2^n n=13
scoreboard players set $2^n math 8192
# 2^r r=3
scoreboard players set $2^r math 8

# 2^(p-q) p = 31 q = 30
scoreboard players set $2^(p-q) math 2

# 2^(q-a-1) q = 30 a = 12
scoreboard players set $2^(q-a-1) math 131072

# 2^(q-a)
scoreboard players set $2^(q-a) math 262144
