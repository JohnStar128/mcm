...
scoreboard players operation $red player_color %= $max_color player_color
scoreboard players operation $green player_color %= $max_color player_color
scoreboard players operation $blue player_color %= $max_color player_color
