...
summon villager 27.5 2 110.5 {Invisible:1b,Invulnerable:1b,Tags:["map5","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}
summon villager 27.5 2 111.0 {Invisible:1b,Invulnerable:1b,Tags:["map5","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}
summon villager 27.5 2 111.5 {Invisible:1b,Invulnerable:1b,Tags:["map5","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}

summon villager 27.5 2 115.5 {Invisible:1b,Invulnerable:1b,Tags:["map6","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}
summon villager 27.5 2 116.0 {Invisible:1b,Invulnerable:1b,Tags:["map6","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}
summon villager 27.5 2 116.5 {Invisible:1b,Invulnerable:1b,Tags:["map6","MapVoteEntity"],NoAI:1,Silent:1b,ActiveEffects:[{Id:14,Amplifier:100,Duration:999999,ShowParticles:0b}]}
...
summon armor_stand 27.5 5 111.0 {Invisible:1b,Marker:1b,Tags:["map5","VoteDisplay","MapVoteEntity"],CustomName:"{\"text\":\"Current votes: \",\"extra\":[{\"score\":{\"name\":\"@s\",\"objective\":\"CmdData\"}}]}",CustomNameVisible:1b}
summon armor_stand 27.5 5 116.0 {Invisible:1b,Marker:1b,Tags:["map6","VoteDisplay","MapVoteEntity"],CustomName:"{\"text\":\"Current votes: \",\"extra\":[{\"score\":{\"name\":\"@s\",\"objective\":\"CmdData\"}}]}",CustomNameVisible:1b}
