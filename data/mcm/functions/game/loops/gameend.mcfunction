...
execute as @e[type=item,tag=KeyItem] at @s if score $didGameEnd CmdData matches 1 run data merge entity @s {PickupDelay:-1s}
...
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run gamerule doDaylightCycle false
...
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run kill @e[type=item,tag=KeyItem]

# clear old tags
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove murderer
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove innocent
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove gunner
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove spectating
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove usedAdrenaline
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run tag @a remove usedTeleport
...
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 run scoreboard players reset @a books
...
execute if score $didGameEnd CmdData matches 1 if score $gameEndTimer CmdData matches ..1 if score $selectedMap CmdData matches 4 run function mcm:maps/launchpad/reset
