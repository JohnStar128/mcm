...
execute as @a[tag=murderer,tag=!retrieved,scores={throwKnife=1..}] if entity @s[nbt=!{Inventory:[{id:"minecraft:carrot_on_a_stick",Count:1b,tag:{CustomModelData:1111}}]}] if entity @e[tag=knifeCosmetic] run item replace entity @s hotbar.1 with minecraft:carrot_on_a_stick{CustomModelData:1111}
...
#execute as @a[tag=murderer,nbt=!{Inventory:[{id:"minecraft:spyglass"}]}] at @s run item replace entity @s hotbar.7 with spyglass
#execute as @a[tag=innocent,nbt=!{Inventory:[{id:"minecraft:spyglass"}]}] at @s run item replace entity @s hotbar.7 with spyglass
