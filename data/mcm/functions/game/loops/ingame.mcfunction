...
execute as @e[type=item,tag=gun] at @s run data modify entity @s Owner set from entity @a[tag=!murderer,tag=!spectating,limit=1,sort=nearest,scores={canPickupGun=0}] UUID
