...
execute if score $murderers GameRules matches ..1 run team join murderers @a[tag=murderer]
...
execute if score $murderers GameRules matches 2.. run team join murderers @a[tag=murderer]
