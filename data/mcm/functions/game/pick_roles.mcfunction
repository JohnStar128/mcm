...
execute as @a[tag=gunner] run item replace entity @s hotbar.1 with warped_fungus_on_a_stick{NoDrop:1b,CustomModelData:1111,display:{Name:'[{"translate":"mcm.item.gun","italic":false}]'}} 1
...
execute as @a[tag=gunner] at @s run item replace entity @s hotbar.8 with netherite_scrap{Item:{id:"minecraft:netherite_scrap",Count:1b,tag:{NoDrop:1b,display:{Name:"{\"translate\":\"mcm.item.scrap\",\"italic\":\"false\"}"},Lore:['[{"translate":"mcm.item.scrap.lore","italic":false}]']}}}
