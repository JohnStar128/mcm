...
execute if score $murderers GameRules matches ..1 run tellraw @a[tag=murderer] {"translate":"mcm.game.role","color":"gold","with":[{"text":"mcm.game.murderer","color":"red"}]}
title @a[tag=murderer] title {"translate":"mcm.game.role","color":"gold","with":[{"text":"mcm.game.murderer","color":"red"}]}
...
execute as @a[tag=gunner] at @s run tellraw @s {"translate":"mcm.game.role","color":"gold","with":[{"text":"mcm.game.gunner","color":"dark_aqua"}]}
execute as @a[tag=gunner] at @s run title @s title {"translate":"mcm.game.role","color":"gold","with":[{"text":"mcm.game.gunner","color":"dark_aqua"}]}
...
title @a[tag=innocent] title {"translate":"mcm.game.role","color":"gold","with":[{"text":"innocent!","color":"light_purple"}]}
