...
execute as @a[tag=gunner,scores={dead=1..},nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick",Count:1b}]}] at @s run summon item ~ ~ ~ {Tags:["deadDrop","KeyItem"],Item:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{CustomModelData:1111,Tags:["KeyItem"],display:{Name:"{\"translate\":\"mcm.item.gun\",\"italic\":\"false\"}"}}}}
