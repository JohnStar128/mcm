...
execute unless entity @e[type=armor_stand,tag=color_boots] run summon armor stand 0 -49 70 {Tags:["color_boots"],ArmorItems:[{id:"minecraft:leather_boots",Count:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1}],Unbreakable:1b,HideFlags:7},{},{},{}]}